...
(* OASIS_START *)
(* DO NOT EDIT (digest: ce548b6c85d2e5be4a7e97616dc9fc85) *)
(*
...
let setup_t =
  {
     ...
     oasis_digest = Some "^\160\b\211\175q\183\161\168,\178\188M\"\023O";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
